...
type OrderService interface {
	...
	GetAllOrder(ctx context.Context, in *AllOrderRes, opts ...client.CallOption) (*AllOrder, error)
...
func (c *orderService) GetAllOrder(ctx context.Context, in *AllOrderRes, opts ...client.CallOption) (*AllOrder, error) {
...
type OrderHandler interface {
	...
	GetAllOrder(context.Context, *AllOrderRes, *AllOrder) error
...
func RegisterOrderHandler(s server.Server, hdlr OrderHandler, opts ...server.HandlerOption) error {
	type order interface {
		...
		GetAllOrder(ctx context.Context, in *AllOrderRes, out *AllOrder) error
...
func (h *orderHandler) GetAllOrder(ctx context.Context, in *AllOrderRes, out *AllOrder) error {
